...
const faqs = [
  ...
  },
  {
    ...
    description:
      "This site depends on a bunch of free services offered by companies like Heroku.com, Netlify.com, GitHub.com and MongoDB.com. The only things that can't be obtained for free is the domain ownership and a bunch of API calls made to Google Places API which I is ready to bear myself. I am commited to keep this site free for ever given that it doesn't punch a hole in my pocket",
  },
  {
    qid: 9,
