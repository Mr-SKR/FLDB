...
const faqs = [
  ...
  },
  {
    ...
    description:
      "Fellow Bengalurians and people living/travelling to Karnataka as most of the Food Lovers TV Vlogs are from this region",
  },
  {
    qid: 4,
    title:
  ...
  },
  {
    ...
    description:
      "Nope. Although, the name is inspired from his youtube channel: Food Lovers TV",
  },
  {
    qid: 6,
  ...
  },
  {
    ...
    description:
      "The plan is to not make money. You heard me right, this site is free to all and does not include any ads, paid promotions or sponsorship. This site is a resultant of what started as my hobby project",
  },
  {
    qid: 8,
    title: "How will FLDb sustain without making any money?",
    description:
      "This site depends on a bunch of free services offered by companies like Heroku.com, Netlify.com, GitHub.com and MongoDB.com. The only things that can't be obtained for free is the domain ownership and a bunch of API calls made to Google Places API which the creator is ready to bear",
  },
  {
    qid: 9,
    title: "How can I contribute to FLDb?",
    description:
      "While financial contributions is not encouraged, you can always contribute from technical point of view by submitting feature requests, bug report etc., @ https://github.com/Mr-SKR/FLDB/issues or marketing by spreading the existence of this site by word of mouth. I'd genuinely feel happy if somebody recommends this site to me someday by the power of word of mouth",
  },
  {
    qid: 10,
    title: "Is this site highly available or scalable?",
    description:
      "Nope. This site depends on a bunch of free services offered by companies like Heroku.com, Netlify.com, GitHub.com and MongoDB.com. These free services can't guarantee high availability and scalability. Since I do not expect a high amount of traffic flowing to this site, this site should manage just fine",
  },
  {
    qid: 11,
  ...
  },
  {
    ...
    description:
      "Code used for building this whole website is presented publicly @ https://github.com/Mr-SKR/FLDB and https://github.com/Mr-SKR/fldb-apis. Feel free to inspect if you've got any free time. These repos are also licenced under https://opensource.org/licenses/MIT. So feel free to re-use anything from here",
  },
];
